...
// 📚 RECURSOS Y TIPS
// =============================================================
btnBuscar.addEventListener("click",buscarPeliculas(inputPelicula.value.trim().toLowerCase()));
