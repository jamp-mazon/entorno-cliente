...
const alumnos_faltosos=alumnos.filter(alumn=>alumn.faltas>=5);
 alumnos_faltosos.forEach(alumno=>{
  console.log(`${alumno.nombre} tiene ${alumno.faltas} faltas. Revisar situacion`);
 });